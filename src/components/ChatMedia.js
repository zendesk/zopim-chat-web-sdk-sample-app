...
class ChatMedia extends Component {
      ...
      default:
        return (
          <a href={this.props.message.attachment.url} target="_blank">
            <div className="chat-msg">⬇️ Download {this.props.message.attachment.name}</div>
          </a>
        )
    }
  }
  ...
  render() {
    return <div className="chat-media-container">{this.renderMediaByType(this.props.message)}</div>
  }
}
